        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item"
                    href="https://themesbrand.com/chatvia/layouts/dark.html#">Share
                    <i
                        class="fal fa-share-alt float-end text-muted"></i></a>
                <a class="dropdown-item"
                    href="https://themesbrand.com/chatvia/layouts/dark.html#">Block
                    <i
                        class="fal fa-ban float-end text-muted"></i></a>
                <a class="dropdown-item"
                    href="https://themesbrand.com/chatvia/layouts/dark.html#">Remove
                    <i
